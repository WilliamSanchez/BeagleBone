...
function writeLED(filename, value, path){
  ...
  try{
    ...
    console.log("The Write Failed to File: "+path+filename);
  }
}
...
if (myArgs[0]==null){
   ...
   console.log(" Usage is node: nodejs nodejsLED.js command");
   console.log(" where command is on of: on, off, flash or status");
   process.exit(2);
}
